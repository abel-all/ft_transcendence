    ...
    return (
        <div className="inboxChatHolder flex flex-col pt-[10px]">
            <div className="Chatuser flex flex-row">
                <div className="InboxUsersList mx-[5px] relative mb-[10px] w-[53.85px] h-[53.85px] basis-2/12">
                    <img className="InboxUser w-[53.85px] h-[53.85px] rounded-full" src={testuser} alt="" />
                    <span className="status bg-[#00FF00] w-[10px] h-[10px] rounded-full absolute bottom-0 right-[21px]"></span>
                </div>
                <div className="UserMessage flex flex-col basis-4/12 pt-[5px]">
                ...
                <div className="spaces basis-4/12"></div>
