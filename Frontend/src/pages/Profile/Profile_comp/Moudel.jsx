...
function Buttn({ toggles, rsn, user, content }) {
  const handelClick = () => {
    if (rsn == 'Block') {
      ...
      axios
        .post('https://www.fttran.tech/api/profile/block-friend/', {
          username: user,
        })
        .then((response) => {
      ...
      axios
        .post('https://www.fttran.tech/api/profile/unblock-friend/', {
          username: user,
        })
        .then((response) => {
      ...
      axios
        .post(
          'https://www.fttran.tech/api/profile/eliminate-friendship-request/',
          {
            username: user,
          }
        )
