...
function MatchHistory({className}) {
    return (
        <div className={"MatchHistor max-h-[687px] overflow-auto w-[620px] p-[5px] md:p-[25px] bg-[var(--bg-color)] border-[1px] border-[#626262] mr-[2px] mt-[4px]" + (className ? ` ${className}` : '')}>
