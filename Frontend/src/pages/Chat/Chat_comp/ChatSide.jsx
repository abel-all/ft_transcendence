...
function ChatSide({ setVoidedUsername, className }) {
	...
	const sendMessageToDataBase = (message, sender, CreateMessages) => {
		...
		if (ChatContext.readyState == ReadyState.OPEN) {
			...
			ChatContext.setlastMessageUserSend(message);
	...
	useEffect(() => {
		CreateMessages.message &&
			messagesAddedLoop(messagesAdded, CreateMessages) &&
					...
					getMessagesFromDataBase && (
						<>
							<sendMessageContext.Provider
								value={{ addMessage, messages, messagesAdded, messagesRef, goToButtom,
									userAbleToSendMessage, CreateMessages, username, setlastMessageUserSend,
								}}
							>
