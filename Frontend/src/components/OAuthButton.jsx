...
function OAuthButton(props) {
    return (
        <div className="bg-[#FFCA61] w-full border border-black mx-auto rounded-[40px] shadow-[5px_5px_5px_rgba(0,0,0,0.4)] hover:scale-[1.02] hover:opacity-90 duration-[400ms]">
