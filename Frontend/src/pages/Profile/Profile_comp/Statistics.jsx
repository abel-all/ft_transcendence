...
function Statistics({className}) {
    return (
        <div className={"w-[620px] h-[318px] p-[5px] md:p-[25px] bg-[var(--bg-color)] border-[1px] border-[#626262] mt-[4px] mr-[2px]" + (className ? ` ${className}` : '')}>
            ...
            <div className="flex flex-row text-[#FFFFFF] opacity-80">
                <div className="pl-[35px] basis-1/2">
                    <span className="text-[20px] font-[500] font-Outfit">Total : 14</span>
                    <ul>
