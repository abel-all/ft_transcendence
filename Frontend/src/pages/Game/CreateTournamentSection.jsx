...
const CreateTournamentSection = ({ title, callToAction, buttonColor }) => {
  ...
  useEffect(() => {
    const fetchActiveTournament = async () => {
      await Axios.get('https://www.fttran.tech/api/tournament/names/', {
  ...
  const createTournament = async () => {
    ...
    if (nameReGex.test(name) && nameReGex.test(tour)) {
      await Axios.post(
        'https://www.fttran.tech/api/tournament/check-name/',
        {
  ...
  const joinTournament = async () => {
    ...
    if (nameReGex.test(name) && nameReGex.test(tour)) {
      await Axios.post(
        'https://www.fttran.tech/api/tournament/check-alias/',
        {
          alias: name,
          tournament_name: tour,
