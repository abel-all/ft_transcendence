...
import {signInFieldProps, itemData, oAuthItems, fieldReGex} from './variables.jsx'
...
function SignIn() {
    ...
    const checkFieldInput = async () => {
        ...
        await Axios.post("https://www.fttran.tech/api/auth/token/", {
...
const resetPassword = async () => {
    ...
    if (fieldReGex.emailReGex.test(email)) {
        await Axios.post("https://www.fttran.tech/api/auth/passwordrecovery/", {
            email: email,
        },
        {
            withCredentials:true,
                ...
                <div className="w-full h-[460px] flex flex-col justify-between">
                    ...
                    <div className="text-input-container flex flex-col gap-[7px]">
                        ...
                        <div className="text-[#eee] opacity-50 text-[14px]">
                            An email containing a alink to reset your password has been sent to the email address associated with your account.
                        </div>
                    </div>
                    :
                    <>
