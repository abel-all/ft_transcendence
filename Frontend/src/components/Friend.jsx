...
function Friend(Data) {
  ...
  const AcceptRequest = (user, statusOfReq) => {
    if (Data.reason == 'Invetations') {
      ...
      axios
        .post(
          'https://www.fttran.tech/api/profile/handle-friendship-request/',
          {
            username: user,
            status: statusOfReq,
          }
  ...
  const SendRequest = (user) => {
    axios
      .post('https://www.fttran.tech/api/profile/send-friendship-request/', {
        username: user,
      })
      .then((respons) => {
      ...
      <div className="flex items-center shrink overflow-hidden">
        <div className="relative shrink-0 overflow-hidden">
          <img
            ...
            src={Data.picture ? Data.picture : FriendPic}
            alt=""
          />
